(function (window) {
    ...
    platform.init = function (game) {
        ...
        // example:
        platform.create(400, 590, 0.75, 0.5);
        platform.create(50, 495, 0.75, 0.5);
        platform.create(450, 400, 0.75, 0.5);
        platform.create(90, 305, 0.75, 0.5);
        platform.create(490, 210, 0.75, 0.5);
